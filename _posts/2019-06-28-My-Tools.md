...
style: fill
color: info
description: Different Designers use different tools. Here's my current list.
---
...
- Affinity Designer, for vector-based visual design work
- Shapr3D, for 3D modelling
- Working Copy, for updating mine and other websites through Git
- LumaFusion, for editing up to 4K video on the iPad
- Trello, for project management with clients
- Zoom, for meetings
- Apple Music, for entertainment
- Notes, for note taking

On the Mac:

- Sketch, for vector-based visual design work (though, I am looking to move to Affinity on all platforms)
- Preview, for quick image edits and background removal

On the Web:

- Figma, for vector-based visual design work when working at Elite Gaming
- Dictionary.com/Thesaurus.com, for inspiration and definitions when working 
- GitHub Pages, for hosting this website and others